        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeatGroup = table.Column<int>(type: "int", nullable: true),
                    Repeat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RepeatTimes = table.Column<int>(type: "int", nullable: true),
                    InterestPenalty = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Discount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PaymentDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    AmoundPaid = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
